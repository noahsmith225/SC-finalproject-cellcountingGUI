...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sizeobject_SB.setDecimals(1)  # Set the number of decimal places displayed to 1
        self.sizeobject_SB.setSingleStep(0.1)  # Set the step value when incrementing/decrementing to 0.1
        self.sizeobject_SB.setValue(0.2)  # Set the initial value of the QDoubleSpinBox to 0.2
